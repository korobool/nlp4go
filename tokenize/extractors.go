...
func extractTokenQuote(s []rune, pos int) (*Token, bool) {
...
func extractTokenPeriod(s []rune, pos int) (*Token, bool) {
...
func extractTokenApostrophe(s []rune, pos int) (*Token, bool) {
	if s[pos] != '\'' {
		return nil, false
	}
...
func extractTokenColon(s []rune, pos int) (*Token, bool) {
	if s[pos] != ':' {
		return nil, false
	}
...
func extractTokenSymbol(s []rune, pos int) (*Token, bool) {
